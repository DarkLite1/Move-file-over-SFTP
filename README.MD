...
1.  **Configuration:**
    ...
    * Refer to the inline help in the script ([Move file over SFTP.ps1](Move%20file%20over%20SFTP.ps1)) for detailed explanations of each configuration parameter.
2.  **Dependencies:**
